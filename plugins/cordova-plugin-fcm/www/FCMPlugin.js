...
FCMPlugin.prototype.getTokenAndRegister = function(authToken, livechatUserId, success, error){
	exec(success, error, "FCMPlugin", 'getTokenAndRegister', [authToken, livechatUserId]);
}
